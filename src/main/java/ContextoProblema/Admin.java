...
public class Admin {
	/***
	 * Este método utiliza la clase "Archivador" para mostrar los camiones almacenados en un archivo de texto en el panel de la interfaz de usuario especificado por "mainPanel"
	 * @param mainPanel
	 */
	...
	/***
	 * Crea un nuevo objeto de la clase "Chofer" con los datos proporcionados y lo agrega a una lista de choferes. Luego, utiliza la clase "Archivador" para guardar el nuevo chofer en el archivo de texto "listaChoferes.txt"
	 * @param nombre
	 * @param rut
	 * @param edad
	 * @param licencia
	...
	/***
	 *  Crea un nuevo objeto de la clase "Pedido" con los datos proporcionados. Luego, utiliza la clase "Archivador" para guardar el nuevo pedido en el archivo de texto "listaPedidos.txt"
	 * @param codigo
	 * @param patenteCamion
	 * @param fechaInicial
	 * @param fechaFinal
